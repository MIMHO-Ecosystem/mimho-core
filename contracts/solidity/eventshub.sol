...
abstract contract MIMHO EventsHub {
    string public constant version = "0.0.0-placeholder";
    function contractType() public pure virtual returns (bytes32) { return keccak256("MIMHO_EVENTS_HUB"); }
}
 *
...
///
/// BscScan:
/// https://bscscan.com/address/0xC4A934CBb3A507e295d2D84C25A6Ed7437C36E42
/// -----------------------------------------------------------------------
