...
abstract contract MIMHO Locker {
    string public constant version = "0.0.0-placeholder";
    function contractType() public pure virtual returns (bytes32) { return keccak256("MIMHO_LOCKER"); }
}
 *
...
///
/// BscScan:
/// https://bscscan.com/address/0xCF1F253D0EFAc28Cf0C96896846A8C70887f9957
/// -----------------------------------------------------------------------
