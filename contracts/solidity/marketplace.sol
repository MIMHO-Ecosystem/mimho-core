...
abstract contract MIMHO Marketplace {
    string public constant version = "0.0.0-placeholder";
    function contractType() public pure virtual returns (bytes32) { return keccak256("MIMHO_MARKETPLACE"); }
}
 *
...
///
/// BscScan:
/// https://bscscan.com/address/0x46da5bdc8d69e64D7167C0AD10209ddb202E9458
/// -----------------------------------------------------------------------
