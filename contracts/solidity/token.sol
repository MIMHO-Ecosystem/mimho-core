...
abstract contract MIMHO Token {
    string public constant version = "0.0.0-placeholder";
    function contractType() public pure virtual returns (bytes32) { return keccak256("MIMHO_TOKEN"); }
}
 *
...
///
/// BscScan:
/// https://bscscan.com/address/0xe6FF9A0Dcf6593f48732C79e53457e367232fD48
/// -----------------------------------------------------------------------
