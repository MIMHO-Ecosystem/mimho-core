...
abstract contract MIMHO PreSale {
    string public constant version = "0.0.0-placeholder";
    function contractType() public pure virtual returns (bytes32) { return keccak256("MIMHO_PRESALE"); }
}
 *
...
///
/// BscScan:
/// https://bscscan.com/address/0xED068a9fD46A0099375318bb6923B5E72EeE924a
/// -----------------------------------------------------------------------
