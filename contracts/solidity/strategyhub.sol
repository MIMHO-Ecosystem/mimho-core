...
abstract contract MIMHO Strategy Hub {
    string public constant version = "0.0.0-placeholder";
    function contractType() public pure virtual returns (bytes32) { return keccak256("MIMHO_STRATEGY_HUB"); }
}
 *
...
///
/// BscScan:
/// https://bscscan.com/address/0x3E259b7d637f8C0C420c68a31f1Af4bf860b3cF4
/// -----------------------------------------------------------------------
